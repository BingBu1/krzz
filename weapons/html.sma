...
#define WaeponIDs 10000 + 4
#define cost 40.0
#define DamageBase 400.0

#define V_MODEL "models/v_m3_a2.mdl"
#define W_MODEL "models/w_m3_a2.mdl"
#define P_MODEL "models/p_m3_a2.mdl"
#define DefWModule "models/w_m3.mdl"

#define FlySound "de_torn/tk_windStreet.wav"
#define FlyModule "models/w_rpggrenade.mdl"

#define cznh "weapon_m3"
...
new waeponid
public plugin_init(){
    new plid = register_plugin("虎头灭灵", "1.0", "Bing")
    ...
    RegisterHookChain(RG_CBasePlayerWeapon_DefaultShotgunReload , "m_Reload")
    ...
    register_clcmd("say /buy_html", "Buymlxg")
    waeponid = BulidWeaponMenu("虎头灭灵", cost)
    BulidCrashGunWeapon("虎头灭灵", W_MODEL , "FreeGive", plid)
}
...
public plugin_precache(){
	...
	g_Explosion = precache_model("sprites/bw_tele.spr")
...
public m_Reload(const this, iAnim, iStartAnim, Float:fDelay, Float:fStartDelay, const pszReloadSound1[], const pszReloadSound2[]){
...
GetWpn:
    ...
    set_member(wpn, m_Weapon_iClip, CLIP)
    rg_set_user_bpammo(id,wpnid,Max_bpammo)
    client_print(id, print_center, "购买成功！攻击力+4.0倍")
}
