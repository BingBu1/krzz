...
#define P_MODEL "models/p_m3_a1.mdl"
...
new waeponid
public plugin_init(){
    new plid = register_plugin("灭灵邪骨", "1.0", "Bing")
    ...
    register_clcmd("say /buy_mlxg", "Buymlxg")
    waeponid = BulidWeaponMenu("灭灵邪骨", cost)
    BulidCrashGunWeapon("灭灵邪骨", W_MODEL , "FreeGive", plid)
}
